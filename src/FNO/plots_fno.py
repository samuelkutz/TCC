...
def eval_fno(model_metadata_file, x_limit, t_limit, eval_params, resolutions, output_dir=None):
...
def eval_fno_2(model_metadata_file, x_limit, t_limit, eval_params, resolutions, output_dir=None):
    ...
    alpha_true_list = []
    alpha_pred_list = []
    print('start fno eval_model_2 alpha/beta panel')
    for val in eval_params:
        bsq = Boussinesq(-x_limit, x_limit, 0, t_limit, val, val, 1)
    ...
    plot_model2_resolution_panel(
        ...
        title='FNO model2: resolution panel',
    )
    ...
    plot_model2_spectral_panel(
        ...
        title='FNO model2: spectral panel',
    )
