...
For a network with a sufficiently large number of parameters, the Jacobian $J(\theta)$ changes negligibly during training, a regime known as lazy training \parencite{jacot2018, chizat2019, wang2022ntk}. Writing $J_0 = J(\theta(0))$ and $K_0 = J_0 J_0^T$, the approximation $K(\theta(\tau)) \approx K_0$ turns equation~\eqref{eq:ntk_dynamics} into a linear ODE with constant coefficients:
